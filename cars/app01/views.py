...
def test (request):
	...
	context['test']= Vehicles.objects_rus.filter(milgr__name = 'до 120',pr_year__pr_year = '2017').aggregate(Count('id'), Avg('price'))
	context['test1'] = Vehicles.objects_rus.filter(pr_year__pr_year=2018).aggregate(Count('id'), Avg('price'))
...
def summary (request):
	context = {}
	context['rus_2018_120'] = Vehicles.objects_rus.filter(milgr__name='до 120', pr_year__pr_year='2018').aggregate(Count('id'),Avg('price'))
	context['rus_2018_70'] = Vehicles.objects_rus.filter(milgr__name='до 70', pr_year__pr_year='2018').aggregate(Count('id'), Avg('price'))
	context['rus_2018_30'] = Vehicles.objects_rus.filter(milgr__name='до 30', pr_year__pr_year='2018').aggregate(Count('id'), Avg('price'))
	context['rus_2019_120'] = Vehicles.objects_rus.filter(milgr__name='до 120', pr_year__pr_year='2019').aggregate(Count('id'), Avg('price'))
	context['rus_2019_70'] = Vehicles.objects_rus.filter(milgr__name='до 70', pr_year__pr_year='2019').aggregate(Count('id'),  Avg('price'))
	context['rus_2019_30'] = Vehicles.objects_rus.filter(milgr__name='до 30', pr_year__pr_year='2019').aggregate(Count('id'), Avg('price'))
	context['rus_2020_120'] = Vehicles.objects_rus.filter(milgr__name='до 120', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['rus_2020_70'] = Vehicles.objects_rus.filter(milgr__name='до 70', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['rus_2020_30'] = Vehicles.objects_rus.filter(milgr__name='до 30', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['rus_2021_120'] = Vehicles.objects_rus.filter(milgr__name='до 120', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['rus_2021_70'] = Vehicles.objects_rus.filter(milgr__name='до 70', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['rus_2021_30'] = Vehicles.objects_rus.filter(milgr__name='до 30', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['rus_2022_120'] = Vehicles.objects_rus.filter(milgr__name='до 120', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))
	context['rus_2022_70'] = Vehicles.objects_rus.filter(milgr__name='до 70', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))
	context['rus_2022_30'] = Vehicles.objects_rus.filter(milgr__name='до 30', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))

	context['de_2018_120'] = Vehicles.objects_de.filter(milgr__name='до 120', pr_year__pr_year='2018').aggregate(Count('id'), Avg('price'))
	context['de_2018_70'] = Vehicles.objects_de.filter(milgr__name='до 70', pr_year__pr_year='2018').aggregate(Count('id'), Avg('price'))
	context['de_2018_30'] = Vehicles.objects_de.filter(milgr__name='до 30', pr_year__pr_year='2018').aggregate(Count('id'), Avg('price'))
	context['de_2019_120'] = Vehicles.objects_de.filter(milgr__name='до 120', pr_year__pr_year='2019').aggregate(Count('id'), Avg('price'))
	context['de_2019_70'] = Vehicles.objects_de.filter(milgr__name='до 70', pr_year__pr_year='2019').aggregate(Count('id'), Avg('price'))
	context['de_2019_30'] = Vehicles.objects_de.filter(milgr__name='до 30', pr_year__pr_year='2019').aggregate(Count('id'), Avg('price'))
	context['de_2020_120'] = Vehicles.objects_de.filter(milgr__name='до 120', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['de_2020_70'] = Vehicles.objects_de.filter(milgr__name='до 70', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['de_2020_30'] = Vehicles.objects_de.filter(milgr__name='до 30', pr_year__pr_year='2020').aggregate(Count('id'), Avg('price'))
	context['de_2021_120'] = Vehicles.objects_de.filter(milgr__name='до 120', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['de_2021_70'] = Vehicles.objects_de.filter(milgr__name='до 70', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['de_2021_30'] = Vehicles.objects_de.filter(milgr__name='до 30', pr_year__pr_year='2021').aggregate(Count('id'), Avg('price'))
	context['de_2022_120'] = Vehicles.objects_de.filter(milgr__name='до 120', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))
	context['de_2022_70'] = Vehicles.objects_de.filter(milgr__name='до 70', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))
	context['de_2022_30'] = Vehicles.objects_de.filter(milgr__name='до 30', pr_year__pr_year='2022').aggregate(Count('id'), Avg('price'))
...
def search(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			call_command('filldb2', brand, model)
...
# >>> Vehicles.objects.filter(production_year__production_year=2020)
	...
	# pv = pivot(Vehicles, ['country', 'pr_year'], 'milgr', 'price', aggregation=Count, default=0)
	# var1, var2, var3, var4, var5, var7, var8, var9, var10, var11 = pv
